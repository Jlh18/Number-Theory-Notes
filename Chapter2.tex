...
\begin{prop}[Vanishing of multivariable polynomials over $\Z_p$]
...
\begin{proof}
    ...
    Thus \linkto{non_empty_projective_limits}{
        $\varprojlim V$ is non-empty if and only if
        each $V_n$ is non-empty.}
